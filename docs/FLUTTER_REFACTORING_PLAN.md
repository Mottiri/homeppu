...
| 10 | 各画面でAppMessages適用（✅ 完了） | メッセージ統一 |

> **注**: 行削減の数値はリファクタリング前との差分の目安。  
> **注**: AppMessages適用は「システムメッセージ／変更可能性の高い文言」を対象とする（2026-01-26 方針更新）。
> **進捗**:
> - ✅ バッチ1完了（2026-01-25）: 通知/カレンダー/問い合わせ/オンボーディング/名前編集
> - ✅ バッチ2完了（2026-01-25）: 目標（一覧/詳細/カード）/設定/参加申請
> - ✅ バッチ3完了（2026-01-25）: タスク（複数削除/カテゴリ削除）/サークル更新/投稿詳細/投稿削除サービス
...
> - ✅ バッチ12完了（2026-01-26）: 404/ダイアログ/動画/管理BAN/タスク系のシステム文言をAppMessages化
> - ✅ AppMessages対応 残り0画面
