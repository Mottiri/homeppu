...
**作成日**: 2026年1月7日
**最終更新**: 2026年1月28日（publicUsers分離、Storage/Firestoreルール強化）
**対象**: homeppu プロジェクト
...
- 2026-01-28: usersの閲覧を本人/管理者のみに限定し、publicUsersを追加して公開用データを分離。banAppealsの重複ルールを整理。サークル画像/投稿ファイル関連のStorageルールを強化。publicUsersの一括同期関数を追加。
