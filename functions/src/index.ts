...
// ===============================================
// マイグレーション: 古い投稿にisVisibleフィールドを追加
// ===============================================
export const migratePostsIsVisible = onCall(
  {
    region: "asia-northeast1",
    timeoutSeconds: 300,
  },
  async () => {
    console.log("=== migratePostsIsVisible START ===");
    ...
    console.log(`=== migratePostsIsVisible COMPLETE: updated=${updatedCount}, skipped=${skippedCount} ===`);
