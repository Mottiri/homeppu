    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Interval Section
          const Text('間隔:', style: TextStyle(color: AppColors.textSecondary)),
          ...
          if (_unit == 'weekly') ...[
            ...
            Row(
              ...
              children: List.generate(7, (index) {
                ...
                final weekday = index == 0 ? 7 : index; // 0->7(Sun), 1->1(Mon)
          ...
          // End Condition
          const Text('終了条件', style: TextStyle(color: AppColors.textSecondary)),
          const SizedBox(height: 8),
