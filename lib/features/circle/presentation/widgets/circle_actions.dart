  ...
  Widget _buildActionButton() {
    ...
    if (isMember) {
      return _buildStatusButton(
        icon: Icons.check,
        label: AppMessages.circle.joinedLabel,
        onPressed: isOwner ? null : onLeave,
      );
    }

    if (hasPendingRequest && !circle.isPublic) {
      return _buildStatusButton(
        icon: Icons.hourglass_empty,
        label: AppMessages.circle.requestPendingLabel,
      );
    }
    ...
    if (circle.memberCount >= circle.maxMembers) {
      return _buildStatusButton(
        icon: Icons.group,
        label: AppMessages.circle.circleFullLabel,
      );
    }
              ...
              children: [
                ...
                Text(
                  circle.isPublic
                      ...
                      : AppMessages.circle.joinRequestButton,
                ),
              ],
            ),
    );
