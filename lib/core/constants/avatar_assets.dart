...
class AvatarAssets {
  ...
  static const List<String> hairIds = ['hair_01'];
  static const List<String> eyesIds = ['eyes_01'];
  static const List<String> mouthIds = ['mouth_01'];
  static const List<String> eyebrowsIds = ['eyebrows_01'];
